...
import styles from "../scss/pages/Impressum.module.scss";
  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        vorgeschrieben ist oder wenn Sie zuvor ausdrücklich eingewilligt haben.
        Die Verarbeitung und Speicherung von Daten erfolgt gemäß den geltenden
        Datenschutzbestimmungen. Bei Fragen zur Verarbeitung Ihrer
