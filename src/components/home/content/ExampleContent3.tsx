...
const ExampleContent3 = () => (
  <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12">
    ...
    <div className="col-span-1 md:col-span-8">
      ...
      <button className="w-full rounded bg-primarylight px-9 py-4 text-xl text-foregroundlight transition-colors hover:bg-primary md:w-fit dark:text-foregrounddark dark:bg-primarylight dark:hover:bg-primarycontent">
